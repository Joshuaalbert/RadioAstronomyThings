...
class RadioArray(object):
    ...
    def loadArrayFile(self,arrayFile):
        ...
        self.locs = ac.SkyCoord(x=d[:,0]*au.m,y=d[:,1]*au.m,z=d[:,2]*au.m,frame='itrs',copy=True)
    ...
    def loadPosArray(self,antennaPos):
        ...
        self.locs = ac.SkyCoord(x=antennaPos[:,0]*au.m,y=antennaPos[:,1]*au.m,z=antennaPos[:,2]*au.m,frame='itrs',copy=True)
